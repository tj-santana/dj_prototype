...
## Global singleton for storing references and utilities

# Paths
const PATHS = {
	"MAIN_MENU": "uid://b0wa83bgodgj8",
	"OVERVIEWTUTORIAL": "uid://cgpiuj0npbf6i",
	...
	"BOSS_CORRUPT_PRES": "uid://dyfls6bxsau75",
	"BOSS_ANTI_CORRUPT_PRES": "uid://bstr10sxixk1y",
